...
export default function TimeLogFilters({ searchTerm, onSearchChange }) {
  return (
    <div className="bg-slate-800 rounded-xl border border-slate-700/70 p-4">
      <label htmlFor="time-log-search" className="block text-slate-400 mb-1 font-medium text-xs">
        Search
      </label>
      <div className="relative">
        ...
        <input
          id="time-log-search"
          type="text"
          placeholder="Search by user name or activity title..."
          value={searchTerm}
