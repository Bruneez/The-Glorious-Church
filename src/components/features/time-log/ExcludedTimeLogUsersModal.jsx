...
export default function ExcludedTimeLogUsersModal({
  excludedStaff = [],
  isOpen,
  onClose,
  onRestore,
  ...
  const handleRestoreConfirm = async () => {
    ...
    try {
      ...
      setError(restoreError?.message || 'Failed to restore user to Time Log.');
    }
  };
        ...
        {confirmingMember ? (
          <>
            <p className="text-slate-300 text-xs leading-relaxed">
              ...
              Time Log module? They will reappear in the time log overview. Their system account and
              historical time log records will remain unchanged.
            </p>
          ...
          <p className="text-slate-400 text-xs leading-relaxed">
            No staff users are currently excluded from the Time Log module.
          </p>
        ) : (
          <div className="space-y-2">
            <p className="text-slate-400 text-xs leading-relaxed">
              These staff users were removed from the Time Log module. Restoring them will not
              change their system account or delete any historical records.
            </p>
