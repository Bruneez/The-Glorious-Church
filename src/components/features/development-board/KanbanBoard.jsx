...
import { KANBAN_COLUMNS } from '@/config/developmentBoardOptions';
  ...
  return (
    <div className="w-full max-w-none min-w-0">
      <div className="overflow-x-auto lg:overflow-x-visible pb-2">
        <div className="flex flex-col md:flex-row gap-3 w-full min-w-0 md:min-w-[720px] lg:min-w-0">
          {KANBAN_COLUMNS.map((column) => {
            ...
            return (
              <div
                key={column.status}
                className="w-full shrink-0 md:flex-1 md:min-w-[220px] md:basis-0 bg-slate-800/50 border border-slate-700/70 rounded-xl flex flex-col max-h-[70vh]"
              >
